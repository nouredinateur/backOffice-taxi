...
<div class="flex justify-between">
    <div style="height: 300px;" class="w-2/5 mx-8">
        ...
        <form class="form">
         <div class="card-body">
          <div class="form-group">
           ...
           <input type="email" class="form-control form-control-solid" placeholder="Role"/>
           <div class="card-footer h-4">
    ...
    <!--begin::List Widget 1-->
<div class=" card card-custom card-stretch gutter-b w-3/5">
    <!--begin::Header-->
