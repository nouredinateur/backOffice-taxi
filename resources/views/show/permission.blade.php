...
<div class="card card-custom card-stretch" id="kt_page_stretched_card">
    ...
    <div class="card-header">
        ...
        <div class="mr-auto card-title">
            <h3 class="card-label">{{ $permission->name }} <small class="ml-2">Permission<small></h3>
        </div>
        <div class="ml-auto p-5">
            <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal">Grant permission to a role</button>
        </div>
                <!-- Modal-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Grant <small>{{ $permission->name }} </small> to a role</label>
                                    <div class="radio-inline">          
                                            @foreach ($allroles as $role)
                                              @if ( !$permission->hasRole($role->name))
                                                <label class="radio radio-rounded">
                                                    <input type="radio" value="{{ $role->name }}"  checked="checked" name="role"/>
                                                    <span></span>
                                                    {{ $role->name }}
                                                </label>
                                              @endif
    ...
    <div class="card-body">
             <!--begin::List Widget 11-->
                ...
                <div class="card-header border-0">
                    <h3 class="card-title font-weight-bolder text-dark">Roles</h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
